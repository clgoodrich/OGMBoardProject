"""Project to visualize, analyze, and understand State of Utah, Division of Oil, Gas, and Mining Board matters.
Relies on the presence of .db file that is outward compiled through accessing the database. This is done because I don't know how to imbed this into the database without just using
my personal login info."""
